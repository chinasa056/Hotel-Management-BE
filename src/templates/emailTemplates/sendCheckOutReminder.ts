...
import { CheckOutReminderOptions } from '../../interfaces/notification';

export const sendCheckOutReminderTemplate = (options: CheckOutReminderOptions): string => {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>This is a reminder that your check-out for reservation <strong>#${options.reservationId}</strong> at <strong>${options.hotelName}</strong> is today, <strong>${formattedCheckOut}</strong>.</p>
          <p><strong>Room:</strong> ${options.roomDetails}</p>
          <p>Please ensure you check out on time. Thank you for staying with us!</p>
