...
import { CheckInReminderOptions } from '../../interfaces/notification';

export const sendCheckInReminderTemplate = (options: CheckInReminderOptions): string => {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>This is a reminder that your check-in for reservation <strong>#${options.reservationId}</strong> at <strong>${options.hotelName}</strong> is tomorrow, <strong>${formattedCheckIn}</strong>.</p>
          <p><strong>Room:</strong> ${options.roomDetails}</p>
          <p>Please arrive prepared. We’re excited to welcome you!</p>
