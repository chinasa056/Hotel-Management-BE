...
import { CancellationNoticeOptions } from '../../interfaces/notification';

export const sendCancellationNoticeTemplate = (options: CancellationNoticeOptions): string => {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Your reservation <strong>#${options.reservationId}</strong> at <strong>${options.hotelName}</strong> has been cancelled.</p>
