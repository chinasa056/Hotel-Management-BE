...
import { PaymentFailureOptions } from '../../interfaces/notification';

export const sendPaymentFailureTemplate = (options: PaymentFailureOptions): string => {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Your payment of <strong>${formattedAmount}</strong> for reservation <strong>#${options.reservationId}</strong> at <strong>${options.hotelName}</strong> could not be processed.</p>
          <p>Please try again: <a href="${options.paymentLink}" class="button">Retry Payment</a></p>
